...
export const BLOG_TRANSACTIONAL_POSTS: BlogPostMeta[] = [
  { slug: 'best-ai-agent-security-software-2026', title: 'Best AI agent security software (2026): buyer’s guide by boundary', description: 'Compare execution gates, MCP security, identity, and governance platforms — and what to deploy first if you need controls this quarter.', publishedAt: date, tags: ['transactional', 'comparison', 'security', 'ai-agents'], readTime: 8, featured: true },
  ...
  { slug: 'ai-agent-approval-platform-comparison-2026', title: 'AI agent approval platform comparison (2026): what to buy', description: 'Side-by-side view of approval UX, policy depth, audit exports, fleet pause, and pricing models for teams shipping autonomous workflows.', publishedAt: date, tags: ['transactional', 'comparison', 'human-in-the-loop', 'product'], readTime: 7 },
  ...
  { slug: 'mcp-security-platform-for-production-teams', title: 'MCP security platform for production teams: what to buy', description: 'Tool gateways vs execution gates — evaluation criteria for teams exposing MCP payment, file, and API tools to LLMs.', publishedAt: date, tags: ['transactional', 'mcp', 'security', 'tool-use'], readTime: 7 },
  ...
  { slug: 'best-human-in-the-loop-approval-software-2026', title: 'Best human-in-the-loop approval software for AI agents (2026)', description: 'Compare durable approval UX, mobile review, SLA escalation, and audit — for teams that must ship HITL without building it in-house.', publishedAt: date, tags: ['transactional', 'comparison', 'human-in-the-loop', 'pwa'], readTime: 7 },
  ...
  { slug: 'ai-agent-security-pilot-week-one-playbook', title: 'AI agent security pilot: week-one playbook for your first 100 actions', description: 'A 5-day rollout: inventory actions, gate top three risks, enable mobile approvals, export audit — designed for fast executive wins.', publishedAt: date, tags: ['transactional', 'get-started', 'pilot', 'operations'], readTime: 6 },
